...
let test = fifaData.filter(item => {
    return item.Year === 2014 && item.Stage === "Final" ;
});
console.log(test[0]['Home Team Name'])
// let newArr = [];
// let test = fifaData.array.forEach(element => {
